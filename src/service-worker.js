...
const cacheWhenPossible = [
  './images/favicons/weather-icon-32.png',
  './images/favicons/weather-icon-48.png',
  './images/favicons/weather-icon-72.png',
  './images/favicons/weather-icon-96.png',
  './images/favicons/weather-icon-128.png',
  './images/favicons/weather-icon-512.png',
